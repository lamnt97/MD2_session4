...
public class Student2 {
    ...
    public Student2(String code, String studentName, boolean sex, int age, float markJS, float markHTML, float markJava) {
        this.code = code;
    ...
    public void inputInfo() {
        ...
        System.out.print("Nhập điểm môn HTML: ");
        this.markHTML = sc.nextFloat();
        System.out.print("Nhập điểm môn JS: ");
        this.markJS = sc.nextFloat();
        System.out.print("Nhập điểm môn Java: ");
